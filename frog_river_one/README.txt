...
Complexidade esperada de espaço para o pior caso é O(X), além do armazenamento de entrada (sem contar o armazenamento necessário para argumentos de entrada.